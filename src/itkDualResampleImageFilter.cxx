 ...
 *
 *=========================================================================*/
#ifndef __itkDualResampleImageFilter_hxx
#define __itkDualResampleImageFilter_hxx
...
DualResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
...
template< typename TInputImage,
          ...
          typename TInterpolatorPrecisionType,
          typename TTransformPrecisionType >
typename DualResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
::PixelType
DualResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
                             ...
                             ThreadIdType threadId)
{
  ...
  // to an output pixel
  PointType outputPoint;         // Coordinates of current output pixel
  PointType outputPoint1;          // Coordinates of current input pixel
  PointType inputPoint;
	PointType tmpOutputPoint;
	PointType tmpOutputPoint1;
  ...
  // Compute corresponding input pixel position
	outputPoint1 = this->m_Transform->TransformPoint(outputPoint);
  inputPoint = this->m_Transform2->TransformPoint(outputPoint1);
  inputPtr->TransformPhysicalPointToContinuousIndex(inputPoint, inputIndex);
  ...
  //
  ++index[0];
  outputPtr->TransformIndexToPhysicalPoint(index, tmpOutputPoint1);
	tmpOutputPoint = this->m_Transform->TransformPoint(tmpOutputPoint1);
  tmpInputPoint = this->m_Transform2->TransformPoint(tmpOutputPoint);
...
template< typename TInputImage,
          ...
          typename TInterpolatorPrecisionType,
          typename TTransformPrecisionType >
const typename DualResampleImageFilter< TInputImage,
                                    TOutputImage,
